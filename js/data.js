...
const DB = {
  ...
  seed() {
    ...
    this.set(this.KEYS.CLIENTS, [
      { id: 1, nombre: 'Tienda La Esperanza', direccion: 'Av. Reforma 123, Col. Centro', lat: 19.4326, lng: -99.1332, referencia: 'Esquina con calle Morelos, portón azul', telefono: '5551112233', estado: 'ACTIVO', zona: 'ZONA_1', codigo: 'CLI-001', numEnvases: 5, rackPrestado: true, notas: 'Compra regular: 5 garrafones semanales', notasMeta: 'Cliente preferente desde 2020', createdAt: '2024-01-01T00:00:00Z' },
      { id: 2, nombre: 'Restaurant El Buen Sabor', direccion: 'Calle Hidalgo 456, Col. Juárez', lat: 19.4250, lng: -99.1600, referencia: 'Entre 5 de Mayo y Guerrero, fachada verde', telefono: '5552223344', estado: 'ACTIVO', zona: 'ZONA_2', codigo: 'CLI-002', numEnvases: 8, rackPrestado: true, notas: 'Demanda alta de hielo los fines de semana', notasMeta: 'Abierto hasta las 11pm', createdAt: '2024-01-02T00:00:00Z' },
      { id: 3, nombre: 'Oficinas TechCorp', direccion: 'Paseo de la Reforma 789, Col. Polanco', lat: 19.4280, lng: -99.1420, referencia: 'Torre corporativa piso 5', telefono: '5553334455', estado: 'ACTIVO', zona: 'ZONA_1', codigo: 'CLI-003', numEnvases: 3, rackPrestado: false, notas: '3 garrafones quincenales, contacto: Lic. Pérez', notasMeta: 'Entrada por calle lateral', createdAt: '2024-01-03T00:00:00Z' },
      { id: 4, nombre: 'Café Moderno', direccion: 'Insurgentes Sur 500, Col. Roma', lat: 19.4180, lng: -99.1550, referencia: 'Junto a la farmacia', telefono: '5554445566', estado: 'NO_COMPRA', zona: 'ZONA_2', codigo: 'CLI-004', numEnvases: 10, rackPrestado: true, notas: 'Solo hielo, 10 bolsas semanales', notasMeta: 'En negociación de precio', createdAt: '2024-01-04T00:00:00Z' },
      { id: 5, nombre: 'Gym FitLife', direccion: 'Av. Universidad 200, Col. Narvarte', lat: 19.4480, lng: -99.1380, referencia: 'Planta baja, local 3', telefono: '5555556677', estado: 'VACACIONES', zona: 'ZONA_3', codigo: 'CLI-005', numEnvases: 6, rackPrestado: true, notas: 'Garrafones para dispensadores', notasMeta: 'Regresa en marzo', createdAt: '2024-01-05T00:00:00Z' },
      { id: 6, nombre: 'Farmacia San José', direccion: 'Av. López Mateos 50, Col. Del Valle', lat: 19.4600, lng: -99.1200, referencia: 'Frente al超市', telefono: '5556667788', estado: 'BAJA', zona: 'ZONA_4', codigo: 'CLI-006', numEnvases: 2, rackPrestado: false, notas: 'Cerró permanentemente', notasMeta: 'Cliente dado de baja', createdAt: '2024-01-06T00:00:00Z' },
    ]);
